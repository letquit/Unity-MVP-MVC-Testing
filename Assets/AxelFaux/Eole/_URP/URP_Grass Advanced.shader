	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float smoothstepResult112_g3647 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_rawMask497_g3566);
				float temp_output_153_0_g3647 = saturate( smoothstepResult112_g3647 );
				float temp_output_544_85_g3566 = ( temp_output_99_0_g3647 * temp_output_153_0_g3647 );
				#if defined(_WIND_NONE)
				float staticSwitch441_g3566 = 0.0;
				#elif defined(_WIND_SIMPLE)
				float staticSwitch441_g3566 = temp_output_544_85_g3566;
				#elif defined(_WIND_ADVANCED)
				float staticSwitch441_g3566 = temp_output_544_85_g3566;
				#else
				float staticSwitch441_g3566 = temp_output_544_85_g3566;
				#endif
				float4 lerpResult62_g3669 = lerp( ifLocalVar131_g3669 , color64_g3669 , ( (float)debugWindTurbulence103_g3669 == 1.0 ? saturate( ( staticSwitch441_g3566 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
...
ASEEND*/
//CHKSM=412DE0A7049F16CC3A72AA44FE57BFA77BC34956